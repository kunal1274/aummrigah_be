    ...
    status: {
      ...
      enum: {
        values: [
          ...
          "CONFIRMED",
          "SHIPPED",
          "DELIVERED", // when ride is completed and driver got the final sign off from customer
          "INVOICED", // once this is invoiced then allocation will be in closed status
          "ADMINMODE",
        ],
        message:
    ...
    settlementStatus: {
      ...
      enum: {
        values: [
          "PAYMENT_PENDING",
          "PAYMENT_PARTIAL",
          "PAYMENT_FULL", // once payment status is full then the allocation will be finalized
          "PAYMENT_FAILED",
          "ADMIN_MODE",
        ],
        message:
